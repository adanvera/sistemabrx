...
function OperacionesReporte() {
  ...
  const handleDataOperationToShow = (operation) => {
    ...
    operation.forEach((op) => {
      ...
      formatOperation.fecha = formatOperation.fecha
  ...
  return (
    ...
    >
      <Container fluid={true}>
        <Row className="mt-3">
          <h4 className="">Reportes general operaciones</h4>
        </Row>
          ...
          <Col>
            ...
            >
              <Card.Body>
                ...
                <Card.Text>{data.totalOperations}</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col>
